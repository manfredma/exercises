...
import manfred.end.design.pattern.black.board.v2.blackboard.BlackboardController;
import manfred.end.design.pattern.black.board.v2.blackboard.KnowledgeSource;
import manfred.end.design.pattern.black.board.v2.heartbeat.HeartbeatSender;
