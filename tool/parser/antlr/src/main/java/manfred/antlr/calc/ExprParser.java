...
public class ExprParser extends Parser {
    ...
    public static final int
            T__0 = 1, T__1 = 2, T__2 = 3, MUL = 4, DIV = 5, ADD = 6, SUB = 7, ID = 8, INT = 9,
            NEWLINE = 10,
            WS = 11;
    public static final int
    ...
    public static class ProgContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExprVisitor)
                return ((ExprVisitor<? extends T>) visitor).visitProg(this);
            else
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                do {
                    ...
                    _la = _input.LA(1);
                        ...
                        ((1L << T__1) | (1L << ID) | (1L << INT) | (1L << NEWLINE))) != 0));
            }
    ...
    public static class StatContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExprVisitor)
                return ((ExprVisitor<? extends T>) visitor).visitStat(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ExprVisitor)
                return ((ExprVisitor<? extends T>) visitor).visitExpr(this);
            else
                return visitor.visitChildren(this);
        }
    }
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            switch (getInterpreter().adaptivePredict(_input, 3, _ctx)) {
                                case 1: {
                                    ...
                                    setState(31);
                                    if (!(precpred(_ctx, 5)))
                                        throw new FailedPredicateException(this, "precpred(_ctx, " +
                                                "5)");
                                    setState(32);
                                    _la = _input.LA(1);
                                    if (!(_la == MUL || _la == DIV)) {
