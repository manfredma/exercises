...
import manfred.end.dci.context.PayBillsContext2;
import manfred.end.dci.context.TransferMoneyContext2;
import manfred.end.dci.domain.data.BalanceData;
import manfred.end.dci.domain.entity.CheckingAccountEntity;
import manfred.end.dci.domain.entity.CreditorEntity;
